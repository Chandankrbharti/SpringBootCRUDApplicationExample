package com.chandan.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.chandan.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.chandan.springboot.model" });
